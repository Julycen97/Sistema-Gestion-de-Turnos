...
--INSERT PACIENTES
INSERT INTO PACIENTES (DNIPERSONA, FECHAAFILIACION, IDCOBERTURA) VALUES
(10987654, '2021-04-15', 1),
(54321099, '2022-05-25', 2),
(32109877, '2023-06-26', 3),
(12345679, '2024-03-30', 4),
(43215678, '2020-05-12', 5),
(87654321, '2021-06-28', 6),
(76543211, '2022-12-10', 7);

--INSERT MEDICOS
INSERT INTO MEDICOS (NUMMATRICULA, DNIPERSONA, IDESPECIALIDAD, ESTADO) VALUES
(12345, 98765434, 1, 1),
(67891, 32109876, 2, 1),
(23456, 76543210, 3, 1),
(78945, 54321098, 4, 1);
...
--INSERT TURNOS
INSERT INTO TURNOS (NUMPACIENTE, MATRICULAMEDICO, IDCATTURNO, IDESPECIALIDAD, FECHAHORATURNO) VALUES
( 1, 12345, 1, 1, '2024-07-01'),
( 2, 67891, 2, 2, '2024-08-10'),
( 3, 23456, 3, 3, '2024-09-15'),
( 4, 78945, 4, 4, '2024-10-21'),
( 5, 12345, 1, 1, '2024-11-26'),
( 6, 67891, 2, 2, '2024-12-30'),
( 7, 23456, 3, 3, '2024-07-08'),
( 1, 78945, 4, 4, '2024-08-01'),
( 2, 12345, 1, 1, '2024-09-19'),
( 3, 67891, 2, 2, '2024-10-28'),
( 4, 23456, 3, 3, '2024-11-29'),
( 5, 78945, 4, 4, '2024-12-27');